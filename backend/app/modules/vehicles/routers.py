...
from app.modules.vehicles.schemas import VehicleCreate, VehicleUpdate, VehicleStatusUpdate, VehicleResponse
...
async def list_vehicles(
    ...
    """List vehicles with optional filters and pagination. All authenticated users can view."""
    return await services.get_vehicles(db, skip=skip, limit=limit, type_filter=type, status_filter=status)
