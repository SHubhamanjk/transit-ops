...
from app.modules.drivers.schemas import DriverCreate, DriverUpdate, DriverStatusUpdate, DriverResponse
...
async def list_drivers(
    ...
    """List drivers with optional filters and pagination. All authenticated users can view."""
    return await services.get_drivers(db, skip=skip, limit=limit, status_filter=status)
