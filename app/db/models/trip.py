...
class Trip(Base):
    ...
    driver_id = Column(UUID(as_uuid=True), ForeignKey("drivers.id", ondelete="RESTRICT"), nullable=False)
    ...
    status = Column(Enum(TripStatusEnum), nullable=False, default=TripStatusEnum.DRAFT)
